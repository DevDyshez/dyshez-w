...
export const dishes = [
  ...
  {
    name: "Aguachile de camarón y chapulines",
    id: "aguachilecatrin",
    restaurantId: "catrin",
    description:
      "Camarones marinados con chapulines acompañados de pepino, cebolla y brotes de cilantro",
    callories: 200,
    price: 195,
  ...
  },
  {
    ...
    id: "muslitoscatrin",
    restaurantId: "catrin",
    description: "Crujientes muslitos de pollo acompañados de papas cambray fritas, bañados en salsa fuego de chile de árbol y limón",
    callories: 200,
    price: 155,
  ...
  },
  {
    ...
    restaurantId: "catrin",
    description:
      "Camarones en adobo, xnipec, mix de quesos y aguacate hass",
    callories: 200,
    price: 215,
    category: "Tacos",
    imageUrl: RocaGravlax1,
  ...
  {
    name: "Steak de Colifflor Horneado",
    id: "platoscatrin",
    restaurantId: "catrin",
    description:
      "Bañado en salsa de chileajo, acompañado de tomate cherry, corazón de lechuga, rábano y cebolla encurtida.",
    callories: 200,
    price: 175,
    category: "Cazuelas y Platos Fuertes",
    imageUrl: RocaGravlax1,
    images: [RocaGravlax1, RocaGravlax2, RocaGravlax3],
    likes: 5,
    comments: 0,
  ...
  {
    name: "Pay de limón local",
    id: "postrecatrin",
    restaurantId: "catrin",
    description:
      "Elaborado con limón indio, masa sableé, merengue suizo flameado y rodaja de limón caramelizada",
    callories: 200,
    price: 140,
    category: "Postres",
    imageUrl: Kibi1,
